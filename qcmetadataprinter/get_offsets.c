...
#define PRINT(PARAM_ID, table_ptr)                                                                  \
    ...
    printf("Size of metadata_buffer_t = %d\n", sizeof(metadata_buffer_t));			    \
...
//    PRINT(XIAOMI_01,    pMetadata);
    PRINT(XIAOMI_02,    pMetadata);
    PRINT(XIAOMI_03,    pMetadata);
    PRINT(XIAOMI_04,    pMetadata);
    PRINT(XIAOMI_05,    pMetadata);
//    PRINT(XIAOMI_06,    pMetadata);
//    PRINT(XIAOMI_07,    pMetadata);
//    PRINT(XIAOMI_08,    pMetadata);
